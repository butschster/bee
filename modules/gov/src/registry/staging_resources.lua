...
local M = {}
M.DATABASE_REF = "bee.governance:database_ref"
M.PUBLICATION_PROFILES_REF = "bee.governance.registry:publication_profiles_ref"
M.ACTIVATION_PROFILES_REF = "bee.governance.registry:activation_profiles_ref"
M.APPROVAL_REQUEST_POLICY_REF = "bee.governance.registry:approval_request_policy_ref"
M.APPROVAL_CONSUME_POLICY_REF = "bee.governance.registry:approval_consume_policy_ref"
