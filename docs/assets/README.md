...
banner.svg and banner.png are the README banner. logo.svg and logo.png are the
repository mark. The SVG files are source assets; PNG files are their raster
exports.
...
model activity, credentials or remote-node claim.
